...
import { FOUNDING_PARTNER, CTAS, SITE, PRICING_SECTION } from "@/lib/constants";
      ...
      <div className="relative page-container">
        <FadeIn>
          <SectionIntro
            ...
            highlight={PRICING_SECTION.highlight}
        ...
        <FadeIn delay={0.08}>
          <article className="value-card glow-purple rounded-2xl p-8 sm:p-10 lg:p-12 relative max-w-3xl mx-auto mt-10 lg:mt-12 overflow-hidden">
            ...
            <div className="text-center mb-8">
              <span className="type-label inline-block bg-forest-mid/80 text-foreground px-4 py-1.5 rounded-full border border-forest-mid/30 mb-5">
                {availability.slotsLabel}
              </span>
              <h3 className="type-price-title mb-3">{FOUNDING_PARTNER.name}</h3>
              <p className="type-body-lg max-w-lg mx-auto text-center text-silver-muted">
            ...
            <div className="rounded-xl border border-silver/10 bg-black-surface/50 p-6 sm:p-8 mb-6 text-center">
              ...
              <p className="text-foreground font-medium text-lg">
                then {formatPrice(FOUNDING_PARTNER.regularPrice)}/mo management fee
              </p>
              <p className="text-[12px] sm:text-sm text-silver-dim mt-2">
                Founding rate locked from month 2 · CAD plus applicable taxes (e.g. HST)
              </p>
              <p className="text-sm text-forest-glow font-medium mt-4 pt-4 border-t border-silver/10">
                {FOUNDING_PARTNER.adSpendNote}
              </p>
            </div>

            <div className="pricing-urgency-note rounded-xl border border-lupin-purple/20 bg-lupin-purple/8 px-5 py-4 mb-8 text-center">
              <p className="text-sm text-silver-muted leading-relaxed">
                {FOUNDING_PARTNER.urgencyNote}
              </p>
            </div>
            ...
            <div className="flex justify-center mb-8">
              <p className="inline-flex items-center gap-2 text-sm text-silver-muted border border-forest-mid/30 bg-forest-mid/10 rounded-full px-4 py-2">
                ...
                >
                  <path
                    d="M12 3l1.2 3.6L17 7.2l-3 2.6.9 3.6L12 11.8 9.1 13.4 10 9.8 7 7.2l3.8-.6L12 3z"
            ...
            <p className="type-label mb-4 text-center text-silver-dim">What&apos;s included</p>
